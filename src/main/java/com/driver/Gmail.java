...
public class Gmail extends Email {
    ...
    public String findLatestMessage(){
        ...
        Triple<Date, String, String> latestMail = inbox.get(inbox.size() - 1);
        return latestMail.getRight();
    }
    ...
    public String findOldestMessage(){
        ...
        if (inbox.size() == 0)return null;
        Triple<Date, String, String> latestMail = inbox.get(0);
        return latestMail.getRight();
    }
    ...
    public int findMailsBetweenDates(Date start, Date end){
        ...
        for (int i = 0; i < inbox.size(); i++) {
            Triple<Date, String, String> currMail = inbox.get(i);
            if (currMail.getLeft().compareTo(start) >= 0 && currMail.getLeft().compareTo(end) <= 0) {
                cnt++;
            }
        }
        return cnt;
